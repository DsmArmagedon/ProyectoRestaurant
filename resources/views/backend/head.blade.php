<meta charset="utf-8" />
        ...
        <!-- BEGIN VALIDATOR STYLES -->
        <link href="{{asset('global/plugins/validator/css/validationEngine.jquery.css')}}" rel="stylesheet" type="text/css" />
        <!-- END FILEUPLOAD STYLES -->
        ...
        <!-- BEGIN SPECIFY STYLES PAGE-->
        @yield('head')
        <!-- END SPECIFY STYLES PAGE-->
