...
<script src="{{asset('apps/scripts/inbox.min.js')}}" type="text/javascript"></script>
<!-- PAGE LEVEL SCRIPTS -->
<!-- BEGIN VALIDATOR SCRIPTS-->
<script src="{{asset('global/plugins/validator/js/jquery.validationEngine.js')}}" type="text/javascript"></script>
<script src="{{asset('global/plugins/validator/js/jquery.validationEngine-es.js')}}" type="text/javascript"></script>
<script src="{{asset('global/plugins/validator/js/jquery.numeric.js')}}" type="text/javascript"></script>
<!-- END VALIDATOR SCRIPTS-->
